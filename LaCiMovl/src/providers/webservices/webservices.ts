...
export class WebservicesProvider {
  ...
  giroscopio_datos(orientacionX, orientacionY, orientacionZ) {
    return new Promise( (resolve, reject) => {
      ...
      // TODO: Encode the values using encodeURIComponent().
      let body = 'orientacionX='+orientacionX+'&orientacionY='+orientacionY+'&orientacionZ='+orientacionZ;
  ...
  delete_giroscopio_datos() {
    return new Promise( (resolve, reject) => {
      ...
      let url = "https://lacimovl.000webhostapp.com/webservices/delete_gir_datos.php";
